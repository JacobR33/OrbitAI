...
def generate_orbit_from_elements(sat_id, a, e, inc, raan, argp, M0, timestamps):
    ...
    for t in timestamps:
        ...
        # Otherwise, solve Kepler's equation (here we assume e is very small)
        nu = M
...
# =============================================================================
# Choose common parameters for the shape:
...
delta_t = pivot_idx * step  # time offset in seconds from simulation start
...
# For SAT_4, choose one set of orientation elements:
inc4 = 0.0    # equatorial
raan4 = 0.0
argp4 = 0.0
